...
import com.sv.visionplus.transaction.invoice_tab.dialog.Item.ItemDialog;
import com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel;
import com.sv.visionplus.transaction.invoice_tab.dialog.confirm.Confirm_Password;
import com.sv.visionplus.transaction.invoice_tab.dialog.customer.CustomerDialog;
import com.sv.visionplus.transaction.invoice_tab.dialog.search_invoice.searchInvoice;
...
import com.sv.visionplus.transaction.invoice_tab.model.TPatientInformation;
 ...
 * @author Mohan
 */
public class PCInvoiceTab extends AbstractObjectCreator<InvoiceMix> {
     ...
     */
    public PCInvoiceTab(AbstractTransactionForm transactionForm) {
        initComponents();
        initOthers();
...
//        form.setVisible(true);
    ...
    private void initOthers() {
        ...
        lstItem.setCellRenderer(new com.sv.visionplus.resource.ui.ItemListRendererTab());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton10, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE))
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGap(44, 44, 44)
                                .addComponent(presbyopiaRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(hypermtropiaRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(astimatismRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName("Basic Invoice Details");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        if (0 > lstItem.getSelectedIndex()) {
            ...
            com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel model = (com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel) selectedItemList.get(lstItem.getSelectedIndex());
    ...
    public void setIdealMode() {
        ...
        invoiceItem = new com.sv.visionplus.transaction.invoice_tab.model.TInvoiceItem();
        lblAmount.setText("0");
    }
    ...
    public void setNewMode() {
        ...
        chxOldInvoice.setSelected(false);
        invoice = new com.sv.visionplus.transaction.invoice_tab.model.TInvoice();
        invoiceMix = new com.sv.visionplus.transaction.invoice_tab.model.InvoiceMix();
        customer = null;
        status = new com.sv.visionplus.transaction.invoice_tab.model.Status();
        patientInformation = new com.sv.visionplus.transaction.invoice_tab.model.TPatientInformation();
        invoiceItem = new com.sv.visionplus.transaction.invoice_tab.model.TInvoiceItem();
        logFile = new visionplusx.logFile.LogFileModel();
        stockLedger = new com.sv.visionplus.transaction.invoice_tab.model.TStockLedger();
    ...
    public void initObject() throws VPException {
        ...
        if (user != null) {
            ...
            if (invoiceMix != null) {
                ...
                java.util.List<com.sv.visionplus.transaction.invoice_tab.model.TInvoiceItem> invoiceItemList = new java.util.ArrayList();
                for (com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel item : selectedItemList) {
...
//                status.setInvoice(0);
                ...
                java.util.List<com.sv.visionplus.transaction.invoice_tab.model.TStockLedger> stockLedgerList = new java.util.ArrayList();
                for (com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel item : selectedItemList) {
    ...
    public void setCustomer(com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer customer) {
        lblStar1.setVisible(false);
        lblStar2.setVisible(false);
        lblStar3.setVisible(false);
        lblStar4.setVisible(false);
        ...
        this.customer = new com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer();
        ...
        java.util.List<com.sv.visionplus.transaction.invoice_tab.model.TInvoice> searchInvoice = InvoiceDAO.getInstance().searchInvoice(customer.getIndexNo());
        double amount = 0.0D;
        for (com.sv.visionplus.transaction.invoice_tab.model.TInvoice invoice : searchInvoice) {
    ...
    public void setItem(com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel mixModel) {
    ...
    public void setValue(com.sv.visionplus.transaction.invoice_tab.model.TInvoice invoice, com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer customer) {
        setNewMode();
        ...
        java.util.List<com.sv.visionplus.transaction.invoice_tab.model.TInvoiceItem> list = InvoiceItemDAO.getInstance().searchItems(invoice.getIndexNo());
        for (com.sv.visionplus.transaction.invoice_tab.model.TInvoiceItem item : list) {
            com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel mix = new com.sv.visionplus.transaction.invoice_tab.dialog.Item.SearchItemMixModel();
            ...
            com.sv.visionplus.transaction.invoice_tab.model.MBrand brand = BrandDAO.getInstance().searchBrand(searchItem.getBrand());
    ...
    private void setInfo(com.sv.visionplus.transaction.invoice_tab.model.TPatientInformation info) {
        if (info != null) {
