...
import com.sv.visionplus.transaction.invoice_tab.SearchItemBulkDAO;
import com.sv.visionplus.transaction.invoice_tab.SearchItemFrontDAO;
...
public final class ItemDialog extends javax.swing.JDialog {
    ...
    private PCInvoiceTab invoiceForm;
    ...
    private void initComponents() {
        ...
        txtQtyOnHand = new com.sv.visionplus.util.component.textfield.CDoubleField();
        jButton1 = new javax.swing.JButton();
        jButton2 = new javax.swing.JButton();
        rdoFrontStock = new javax.swing.JRadioButton();
        rdoBulkStock = new javax.swing.JRadioButton();
        rdoNonStock = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(rdoFrontStock);
        rdoFrontStock.setSelected(true);
        rdoFrontStock.setText("Fornt Stock");
        rdoFrontStock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdoFrontStockActionPerformed(evt);
            }
        });

        buttonGroup1.add(rdoBulkStock);
        rdoBulkStock.setText("Bulk Stock");
        rdoBulkStock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdoBulkStockActionPerformed(evt);
            }
        });

        buttonGroup1.add(rdoNonStock);
        rdoNonStock.setText("Non-stock");
        rdoNonStock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdoNonStockActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(rdoFrontStock)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(rdoBulkStock))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtSalesPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtQtyOnHand, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(rdoNonStock)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (tblItem.getSelectedRowCount() == 1) {
            SearchItemMixModel mixModel = new SearchItemMixModel();
            mixModel.setItem(Integer.parseInt(tblItem.getValueAt(tblItem.getSelectedRow(), 0).toString()));
            mixModel.setCode(tblItem.getValueAt(tblItem.getSelectedRow(), 1).toString());
            mixModel.setName(tblItem.getValueAt(tblItem.getSelectedRow(), 2).toString());
            mixModel.setBrand_name(tblItem.getValueAt(tblItem.getSelectedRow(), 3).toString());
            mixModel.setCategory_name(tblItem.getValueAt(tblItem.getSelectedRow(), 4).toString());
            mixModel.setSale_price(Double.parseDouble(model.getValueAt(tblItem.getSelectedRow(), 5).toString()));
            mixModel.setTotal_qty(txtQtyOnHand.getCValue());
            mixModel.setStore_name("Store Name");

            if (rdoFrontStock.isSelected()) {
                mixModel.setStore_id(1);
                mixModel.setIsstock_item(true);

            } else if (rdoBulkStock.isSelected()) {
                mixModel.setStore_id(2);
                mixModel.setIsstock_item(true);

            } else {
                mixModel.setStore_id(0);
                mixModel.setIsstock_item(false);

            }
            double oldValue = mixModel.getSale_price();
            if (oldValue > txtSalesPrice.getCValue()) {
                mixModel.setDicsount(oldValue - txtSalesPrice.getCValue());
            }else{
            mixModel.setSale_price(txtSalesPrice.getCValue());
            }

            invoiceForm.setItem(mixModel);
            this.dispose();
    ...
    private void tblItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblItemMouseClicked
        if (tblItem.getSelectedRowCount() == 1) {
            double salePrice = Double.parseDouble(model.getValueAt(tblItem.getSelectedRow(), 5).toString());
            double qtyOnHand = 1.00;
    ...
    private void rdoBulkStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoBulkStockActionPerformed
        setDataToRadio();
    }//GEN-LAST:event_rdoBulkStockActionPerformed

    private void rdoFrontStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoFrontStockActionPerformed
        setDataToRadio();
    }//GEN-LAST:event_rdoFrontStockActionPerformed

    private void rdoNonStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoNonStockActionPerformed
        setDataToRadio();
    }//GEN-LAST:event_rdoNonStockActionPerformed
    ...
    private javax.swing.JRadioButton rdoBulkStock;
    private javax.swing.JRadioButton rdoFrontStock;
    private javax.swing.JRadioButton rdoNonStock;
    ...
    private com.sv.visionplus.util.component.textfield.CDoubleField txtQtyOnHand;
    private com.sv.visionplus.util.component.textfield.CDoubleField txtSalesPrice;
    // End of variables declaration//GEN-END:variables
    

    public void setFrame(PCInvoiceTab invoiceForm) {
    ...
    private void addItemNon(List<SearchItemBulk> items) {
        model.setRowCount(0);
        for (SearchItemBulk item : items) {
            addItemNon(item);
        }
    ...
    private void removeRow(String name, int colunm) {
        if (model.getRowCount() > 0) {
            for (int i = 0; i < model.getRowCount(); i++) {
                if (model.getValueAt(i, colunm) != name) {
                    model.removeRow(i);
                }
