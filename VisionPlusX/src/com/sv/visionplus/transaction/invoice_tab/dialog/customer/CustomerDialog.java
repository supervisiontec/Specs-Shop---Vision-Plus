...
public class CustomerDialog extends javax.swing.JDialog
{
  ...
  private void selectButtonActionPerformed(java.awt.event.ActionEvent evt) {
    if (tblCustomer.getSelectedRowCount() == 1) {
      ...
      customer = new com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer();
  ...
  private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    customer.setContactNo(txtContactNo.getText());
    java.util.List<com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer> searchCustomer = CustomerService.getInstance().searchCustomer(customer);
  ...
  private com.sv.visionplus.transaction.invoice_tab.PCInvoiceTab pcInvoice;
  
  private com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer customer;
  
  private javax.swing.table.DefaultTableModel model;
  
  public void setFrame(com.sv.visionplus.transaction.invoice_tab.PCInvoiceTab pcInvoice)
  {
  ...
  {
    java.util.List<com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer> allCustomer = CustomerService.getInstance().allCustomer();
    addData(allCustomer);
  }
  
  private void addData(java.util.List<com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer> allCustomer) {
    model.setRowCount(0);
    for (com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer customer : allCustomer) {
      addData(customer);
    }
  }
  
  private void addData(com.sv.visionplus.transaction.invoice_tab.dialog.customer.model.MCustomer customer) {
