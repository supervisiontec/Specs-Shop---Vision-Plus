 ...
 */
package com.sv.visionplus.transaction.invoice_tab.dialog.search_invoice;
...
import com.sv.visionplus.transaction.invoice_tab.CustomerDAO;
import com.sv.visionplus.transaction.invoice_tab.InvoiceDAO;
...
public class searchInvoice extends javax.swing.JDialog {
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
        ...
        if (tblInvoice.getSelectedRowCount() == 1) {
            ...
            invoice.setIsdelete(new Boolean(model.getValueAt(tblInvoice.getSelectedRow(), 11).toString()));
    ...
    private PCInvoiceTab pcInvoice;

    public void setFrame(PCInvoiceTab pCInvoice) {
        pcInvoice = pCInvoice;
    }

    private void setAllInvoice(String date) {
        System.out.println(date);
        java.util.List<TInvoice> listInvoice = com.sv.visionplus.transaction.invoice_tab.InvoiceDAO.getInstance().allInvoice(date);
        MCustomer customer = new MCustomer();
        model.setRowCount(0);
