 ...
 * @author Supervision
 */
public class VoucherSummary extends javax.swing.JDialog {
     ...
     */
    public VoucherSummary(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        panelReport.setVoucherSummary(fromDate, toDate);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoucherSummary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoucherSummary dialog = new VoucherSummary(new javax.swing.JFrame(), true);
