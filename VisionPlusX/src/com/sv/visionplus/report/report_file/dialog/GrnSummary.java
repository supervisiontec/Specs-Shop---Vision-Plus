 ...
 * @author Supervision
 */
public class GrnSummary extends javax.swing.JDialog {
     ...
     */
    public GrnSummary(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        panelReport.setGrnSummary(fromDate, toDate);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrnSummary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GrnSummary dialog = new GrnSummary(new javax.swing.JFrame(), true);
